...
<template>
    <div class="card overflow-hidden">
        ...
        <p
            ...
            class="mt-0 mb-0 disabled-watcher"
        >
            <svg
            ...
            <span class="ml-1" v-if="recordingStatus == 'wrong-cache'"
                >The 'array' cache cannot be used. Please use a persistent
                cache.</span
            >
        </p>
        ...
        <div v-if="ready && entries.length > 0" class="code-bg">
            <transition-group tag="div" name="list">
                <div v-for="entry in entries" :key="entry.id" class="p-3">
                    <div
                        class="entryPointDescription d-flex justify-content-between align-items-center"
                    >
                        <router-link
                            :to="{
