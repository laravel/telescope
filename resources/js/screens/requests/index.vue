...
<template>
    <index-screen title="Requests" resource="requests">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <span class="badge font-weight-light" :class="'bg-'+requestStatusClass(slotProps.entry.content.response_status)">
            ...
            <td class="table-fit">
                <router-link :to="{name:'request-preview', params:{id: slotProps.entry.id}}" class="control-action text-decoration-none">
