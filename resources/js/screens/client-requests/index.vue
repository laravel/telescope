...
<template>
    <index-screen title="HTTP Client" resource="client-requests">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <span class="badge font-weight-light" :class="'bg-'+requestStatusClass(slotProps.entry.content.response_status !== undefined ? slotProps.entry.content.response_status : null)">
            ...
            <td class="table-fit">
                <router-link :to="{name:'client-request-preview', params:{id: slotProps.entry.id}}" class="control-action text-decoration-none">
