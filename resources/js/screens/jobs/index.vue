...
<template>
    <index-screen title="Jobs" resource="jobs">
        ...
        <template slot="row" slot-scope="slotProps">
            ...
            <td class="table-fit">
                <span class="badge font-weight-light" :class="'badge-'+statusClass(slotProps.entry.content.status)">
                    {{slotProps.entry.content.status}}
                </span>

<!--                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="icon fill-success" v-if="slotProps.entry.content.status == 'processed'">
